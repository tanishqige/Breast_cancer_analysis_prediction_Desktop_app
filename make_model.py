...
class mainWindow(QMainWindow):
    ...
    #my_edit
    def __init__(self,parent=None,nol=4,category='classification',no_of_output=2,no_of_features=31,optimizer='adam'):
        super().__init__()
    ...
    def createButton(self,text,fun,x,y,l,w):
        ...
        return pushButton
               ...
               #my_edit
def Main(parent=None,noh=4,category='classification',no_of_output=2,no_of_features=31,optimizer = 'adam'):
