...
QLineEdit = QtWidgets.QWidget()
QHBoxLayout = QtWidgets.QWidget()
QPushButton = QtWidgets.QWidget()
...
class mainWindow(QMainWindow):
    ...
    def initUI(self):               
        ...
        #self.webmodule = self.createButton("Prediction",self.open_webbrowser,120,220,100,100)
    ...
    #def open_webbrowser():
        #self.m = webbrowser.open('http://www.google.com')
